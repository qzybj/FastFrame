 ...
 */
public class PopWin4List extends BasePopupWindow {

    private ListView mListView;
    private OnListPopupItemClickListener mOnListPopupItemClickListener;

    private PopWin4List(Activity context) {
        super(context);
    }
    private PopWin4List(Activity context, Builder builder){
        this(context);
    ...
    public static class Builder{
        ...
        public PopWin4List build(){
            return new PopWin4List(mContext,this);
        }
    ...
    class ListPopupAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView==null){
                vh=new ViewHolder();
                convertView=mInflater.inflate(R.layout.popwin_item_list,parent,false);
    ...
    public View getPopupView() {
        return getPopupViewById(R.layout.popwin_list);
    }
