 ...
 * 微信朋友圈评论弹窗
 */
public class PopWin4Comment extends BasePopupWindow implements View.OnClickListener {
    ...
    public PopWin4Comment(Activity context) {
        this(context, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    public PopWin4Comment(Activity context, int w, int h) {
        super(context, w, h);
    ...
    public void showPopupWindow(View v) {
        try {
            ...
            mPopupWindow.showAtLocation(v, Gravity.RIGHT | Gravity.TOP, (int) (v.getWidth() * 1.8),
                    viewLocation[1] - DimensUtil.dp2px(mContext,15f));
    ...
    public View getPopupView() {
        return LayoutInflater.from(mContext).inflate(R.layout.popwin_comment, null);
    }
