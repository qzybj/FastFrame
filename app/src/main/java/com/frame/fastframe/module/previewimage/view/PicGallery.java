package com.frame.fastframe.module.previewimage.view;
...
/**
 * 图片浏览 Gallery 配合 ZoonImageView使用
 * @author LangShaoPeng
 *
 */
...
public class PicGallery extends Gallery {
    ...
    @SuppressLint("ClickableViewAccessibility") public PicGallery(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
        ...
        if (view instanceof ZoomImageView) {
            ...
            float min_distance = DisplayImageActivity.screenWidth / 4f;
            ...
            if ((int) width <= DisplayImageActivity.screenWidth
                    && (int) height <= DisplayImageActivity.screenHeight)// 如果图片当前大小<屏幕大小，直接处理滑屏事件
            {
                ...
                if (distanceX > 0)// 向左滑动
                {
                    if (r.left > 0 || right < DisplayImageActivity.screenWidth) {// 判断当前ImageView是否显示完全
                        super.onScroll(e1, e2, distanceX, distanceY);
                    } else {
                ...
                {
                    if (r.right < DisplayImageActivity.screenWidth || left > 0) {
                        super.onScroll(e1, e2, distanceX, distanceY);
                    } else {
                        imageView.postTranslate(-distanceX, -distanceY);
                    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (view instanceof ZoomImageView) {
                ...
                // + height + ",screenWidth="
                // + DisplayImageActivity.screenWidth + ",screenHeight="
                // + DisplayImageActivity.screenHeight);
                if ((int) width <= DisplayImageActivity.screenWidth
                        && (int) height <= DisplayImageActivity.screenHeight)// 如果图片当前大小<屏幕大小，判断边界
                {
                    break;
                }
                float v[] = new float[9];
                ...
                if (top < 0 && bottom < DisplayImageActivity.screenHeight) {
//                    imageView.postTranslateDur(-top, 200f);
                    imageView.postTranslateDur(DisplayImageActivity.screenHeight
                            - bottom, 200f);
                }
                if (top > 0 && bottom > DisplayImageActivity.screenHeight) {
//                    imageView.postTranslateDur(DisplayImageActivity.screenHeight
//                            - bottom, 200f);
                ...
                if(left<0 && right< DisplayImageActivity.screenWidth){
//                    imageView.postTranslateXDur(-left, 200f);
                    imageView.postTranslateXDur(DisplayImageActivity.screenWidth
                            - right, 200f);
                }
                if(left>0 && right>DisplayImageActivity.screenWidth){
//                    imageView.postTranslateXDur(DisplayImageActivity.screenWidth
