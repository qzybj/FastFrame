package com.frame.fastframe.module.editimage;
...
import com.frame.fastframe.module.common.util.DateUtil;
 ...
 */
public class UCropSampleActivity extends UCropBaseActivity {

    private static final String TAG = "UCropSampleActivity";

    private static final int REQUEST_SELECT_PICTURE = 0x01;
    private static final String SAMPLE_CROPPED_IMAGE_NAME = "SampleCropImage";
    private static final String SAMPLE_CROPPED_IMAGE_NAME_SUFFIX = ".jpeg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ucrop_activity_sample);

        mDestinationUri = Uri.fromFile(new File(getCacheDir(), getImgName()));
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PICTURE) {
                ...
                if (selectedUri != null) {
                    ...
                    Toast.makeText(UCropSampleActivity.this, R.string.toast_cannot_retrieve_selected_image, Toast.LENGTH_SHORT).show();
                }
...
//        }
    ...
    private void startCropActivity(@NonNull Uri uri) {
        ...
        uCrop.start(UCropSampleActivity.this);
    }
    ...
    private void handleCropResult(@NonNull Intent result) {
        ...
        if (resultUri != null) {
            UCropResultActivity.startWithUri(UCropSampleActivity.this, resultUri);
        } else {
            Toast.makeText(UCropSampleActivity.this, R.string.toast_cannot_retrieve_cropped_image, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void handleCropError(@NonNull Intent result) {
        ...
        if (cropError != null) {
            ...
            Toast.makeText(UCropSampleActivity.this, cropError.getMessage(), Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(UCropSampleActivity.this, R.string.toast_unexpected_error, Toast.LENGTH_SHORT).show();
        }
    }

    private String getImgName(){
        return SAMPLE_CROPPED_IMAGE_NAME+"_"+ DateUtil.getTimeString()+SAMPLE_CROPPED_IMAGE_NAME_SUFFIX;
    }
