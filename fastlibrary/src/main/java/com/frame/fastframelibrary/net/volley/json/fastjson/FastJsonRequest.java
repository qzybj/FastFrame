...
package com.frame.fastframelibrary.net.volley.json.fastjson;
...
public class FastJsonRequest<T> extends Request<T>{
    ...
    public FastJsonRequest(int method, String url, Class<T> cls, String requestBody, Listener<T> listener,
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        try {
    		...
    		T parsedGSON = JSON.parseObject(jsonString, mJavaClass);
