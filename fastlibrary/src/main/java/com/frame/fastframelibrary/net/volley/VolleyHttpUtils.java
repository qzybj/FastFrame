...
import com.frame.fastframelibrary.net.volley.json.gson.GsonRequest;
import com.frame.fastframelibrary.net.volley.listener.VolleyResultListener;
import com.frame.fastframelibrary.utils.LogUtils;

/**Volley工具类*/
public class VolleyHttpUtils{
	private final String TAG = VolleyHttpUtils.class.getSimpleName();
	private static VolleyHttpUtils instance;
	...
	public static VolleyHttpUtils getInstance(Context con) {
		if (instance==null) {
			instance = new VolleyHttpUtils();
			instance.init(con);
			return instance;
		} else {
			return instance;
