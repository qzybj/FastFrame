...
import earlll.com.testdemoall.aosp.baserecyclerviewadapterhelper.adapter.ItemDragAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnItemDragListener listener = new OnItemDragListener() {
            ...
            public void onItemDragStart(RecyclerView.ViewHolder viewHolder, int pos) {
                ...
                ((CardView)viewHolder.itemView).setCardBackgroundColor(ContextCompat.getColor(ItemDragAndSwipeUseActivity.this, R.color.color_20cdff));
            }
        ...
        OnItemSwipeListener onItemSwipeListener = new OnItemSwipeListener() {
            ...
            public void onItemSwipeMoving(Canvas canvas, RecyclerView.ViewHolder viewHolder, float dX, float dY, boolean isCurrentlyActive) {
                canvas.drawColor(ContextCompat.getColor(ItemDragAndSwipeUseActivity.this, R.color.color_20cdff));
