package earlll.com.testdemoall.aosp.xrecyclerview.ui;
...
public class MultiHeaderActivity extends AppCompatActivity {
    ...
    private CXecyclerViewAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setArrowImageView(R.drawable.xrecyclerview_arrow_down_grey);
        ...
        View header2 = LayoutInflater.from(this).inflate(R.layout.recyclerview_view_header, (ViewGroup)findViewById(android.R.id.content),false);
        ...
        mAdapter = new CXecyclerViewAdapter(listData);
