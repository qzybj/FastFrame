...
public class WXConstant {
    ...
    public final static String TAG = "wxsdk";
    ...
    public final static String WEIXIN_STATE = "wxlibrary_weixin_request"+new Random(4);
     ...
     * */
    public final static String SENDAUTH_GET_USERINFO_URL = SERVER_URL+GET_USERINFO_URL+"?access_token=%s&openid=%s";
